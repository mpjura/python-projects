...
**[Fibonacci Sequence](https://github.com/mpjura/python-projects/blob/master/Numbers/fibonnaci-sequence.py)** - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

**Prime Factorization** - Have the user enter a number and find all Prime Factors (if there are any) and display them.

**Next Prime Number** - Have the program find prime numbers until the user chooses to stop asking for the next one.

**[Find Cost of Tile to Cover W x H Floor](https://github.com/mpjura/python-projects/blob/master/Numbers/tile-calculator.py)** - Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.
...
**[Collatz Conjecture](https://github.com/mpjura/python-projects/blob/master/ClassicAlgorithms/collatz-conjecture.py)** - Start with a number *n > 1*. Find the number of steps it takes to reach one using the following process: If *n* is even, divide it by 2. If *n* is odd, multiply it by 3 and add 1.

**[Sorting](https://github.com/mpjura/python-projects/blob/master/ClassicAlgorithms/)** - Implement two types of sorting algorithms: [Merge sort](https://github.com/mpjura/python-projects/blob/master/ClassicAlgorithms/merge-sort.py) and [bubble sort](https://github.com/mpjura/python-projects/blob/master/ClassicAlgorithms/merge-sort.py).
...
**[Reverse a String](https://github.com/mpjura/python-projects/blob/master/Text/reverse-string.py)** - Enter a string and the program will reverse it and print it out.

**[Pig Latin](https://github.com/mpjura/python-projects/blob/master/Text/pig-latin.py)** - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

**[Count Vowels](https://github.com/mpjura/python-projects/blob/master/Text/count-vowels.py)** - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

**[Check if Palindrome](https://github.com/mpjura/python-projects/blob/master/Text/check-palindrome.py)** - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

**[Count Words in a String](https://github.com/mpjura/python-projects/blob/master/Text/count-words.py)** - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
...
**[Port Scanner](https://github.com/mpjura/python-projects/blob/master/Networking/port-scanner.py)** - Enter an IP address and a port range where the program will then attempt to find open ports on the given computer by connecting to each of them. On any successful connections mark the port as open.
